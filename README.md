...
Malgré sa popularité, j'ai choisi de ne pas intégrer AngularFire dans ce cours. GitHub Firebase/AngularFire Vous emploierez l'API JavaScript mise à disposition directement par Firebase.
